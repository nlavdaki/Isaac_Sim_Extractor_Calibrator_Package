...
# headless -> flat ~1100 lux). But in the FULL GUI it lights correctly
# (viewport-verified ~24800 lux). So we run the GUI lighting, automated:
...
SCHEDULE_CSV = r"../Vz Studio/data/extraction_schedule/schedule_Location_A.csv"
OUT_CSV      = r"../Vz Studio/data/lux_csv/lux_Location_A.csv"
ROOF_PX      = (506, 418)     # pixel on a sunlit roof (View>Illuminance click readout)
RT_SUBFRAMES = 24             # path-tracing subframes (stable by ~16)
