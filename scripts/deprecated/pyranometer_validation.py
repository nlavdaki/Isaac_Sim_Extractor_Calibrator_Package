r"""DEPRECATED: superseded by validate_thissio.py and validate_site.py.

Validate calibrated GHI against in-situ pyranometer measurements (uv, GPU-free).

Compares model-predicted GHI against a real pyranometer at a rooftop.
Pyranometer data is not yet available; this scaffold is written and self-tested now
...
def main():
    ...
    p.add_argument("--out", default=r"../Vz Studio/data/results/pyranometer_validation_summary.csv")
    p.add_argument("--scatter", default=r"../Vz Studio/data/results/pyranometer_validation_scatter.png")
